...
#define MENU_PATH       "/sys/class/leds/led:rgb_green/brightness"
#define BACK_PATH       "/sys/class/leds/led:rgb_blue/brightness"
...
static void handleButtons(const LightState& state) {
    uint32_t brightness = state.color & 0xff;
    set(MENU_PATH, brightness);
    set(BACK_PATH, brightness);
}
